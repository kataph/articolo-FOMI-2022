...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item The function taxonomy is just three levels deep. This presumably, helps with systematicity, but it imposes only three subsumption-granularity levels (e.g., we cannot distinguish between cooling and heating without expanding the original taxonomy).
  \end{itemize}
...
In this approach, a functional decomposition of an engineering system is achieved by alternating the decomposition between engineering methods and functions. 
