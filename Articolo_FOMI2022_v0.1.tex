...
supplies a separate category for `way-of-achievements' (from now on `engineering methods'), which can then be specialized into different function- and method-kinds. Let us assume that these classes are sufficiently characterised from the ontological viewpoint, possibly by adopting a foundational ontology. %but this is outside the scope of this paper and we delegate it to further research work. 
